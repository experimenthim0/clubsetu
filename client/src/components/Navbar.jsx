      ...
      >
        ...
        <div className="max-w-[1200px] mx-auto px-5 lg:px-8 h-16 flex items-center justify-between gap-4">
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            <Link to="/events" className={navLinkCls('/events')}>Events</Link>
            <Link to="/clubs"  className={navLinkCls('/clubs')}>Clubs</Link>
          </div>
                  ...
                  {dropdownOpen && (
                    ...
                    >
                      ...
                      <div className="px-4 pt-3 pb-2 border-b border-neutral-100">
                        ...
                        <p className="text-[14px] font-black text-black truncate">{user.name}</p>
                      ...
                      <div className="py-1">
                        <Link
                          ...
                          role="menuitem"
                        >
                          <i className="ri-user-line text-orange-600" /> My Profile
                        </Link>
                        ...
                        {role === 'student' && (
                          <Link
                            ...
                            role="menuitem"
                          >
                            <i className="ri-calendar-check-line text-orange-600" /> My Events
                          </Link>
                        )}
                        ...
                        {role === 'club-head' && (
                          <Link
                            ...
                            role="menuitem"
                          >
                            <i className="ri-calendar-event-line text-orange-600" /> Created Events
                          </Link>
                        )}
                      </div>
          ...
          <div className="px-5 pt-4 pb-6 flex flex-col gap-0">
            ...
            {user && (
              <div className="flex items-center gap-3 pb-4 mb-1 border-b-2 border-black">
                ...
                <div>
                  <p className="font-black text-[15px] text-black leading-tight">{user.name}</p>
                  <p className="text-[10px] uppercase tracking-widest text-orange-600 font-bold mt-0.5">
                    {role === 'club-head' ? 'Club Head' : 'Student'}
                  </p>
                </div>
